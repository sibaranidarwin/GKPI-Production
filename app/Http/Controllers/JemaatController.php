...
class JemaatController extends Controller
{
    ...
    function formkeluarga(Request $request)
    {
        ...
        return view("jemaat.formkeluarga");
    }
    function formkeluargaprocess(Request $request)
    {
        ...
        return redirect()->route('jemaat.formkeluarga');
    }
    ...
    public function editdatakeluarga($id)
    {
        ...
        $lampiran = explode("#", $keluarga['lampiran']);
        $jemaat = DB::select('Select j.*, jk.status, s.nama as sektor_name FROM jemaat j INNER JOIN jemaat_keluarga jk ON j.nik = jk.nik INNER JOIN sektor s ON s.id =j.sektor_id WHERE jk.no_kk = ?', [$id]);
        return view('jemaat.editdatakeluarga', ["keluarga" => $keluarga, 'lampiran' => $lampiran,  'jemaats' => $jemaat]);
    }
 ...
 $jemaat = Jemaat::all();
    ...
    function formjemaat(Request $request, $idKeluarga)
    {
        ...
        return view('jemaat.formjemaat', ['sektors' => $sektors, 'keluarga' => $keluarga]);
    }
    ...
    function formjemaatprocess(Request $request, $idKeluarga)
    {
        ...
        if (!$jemaat->save()) {
            ...
            return redirect('/jemaat/data/keluarga/' . $idKeluarga);
        }
    }
    function administrasi()
    {
        $administrasi = Administrasi::with(['jemaat.sektor'])->where('nik', "1212100107020004")->get();
        return view('jemaat.administrasishow', [
    ...
    function detailjemaat(Request $request, $nik){
        ...
        return view('jemaat.detailjemaat', ['jemaat'=> $jemaat,'lampiran'=> $lampiran]);
    }
    function pelayan()
    {
    ...
    function formpelayan(Request $request)
    {
        ...
        return view("jemaat.formdatapelayan");
    }
    function formpelayanprocess(Request $request)
    {
        ...
        return redirect('/jemaat/pelayangereja')->with('success', 'Data Pelayan Berhasil Disimpan!');
    }
}