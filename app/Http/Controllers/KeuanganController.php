...
class KeuanganController extends Controller
{
    public function index(){
        ...
        return view('Pendeta.datakeuangan',compact('datakeuangan'));
    }
    
    public function index2(){
        $datakeuangan = Keuangan::all()->where('status_keuangan','Non-Aktif');
        return view('Pendeta.datakeuangannonaktif',compact('datakeuangan'));
    } 

    function formkeuangan(Request $request)
    {
        return view("Pendeta.formtambahkeuangan");
    }
    ...
    function formkeuanganprocess(Request $request)
    {
        ...
        return redirect()->route('pendeta.datakeuangan');
    }

    public function ubahkeuangan($id){
        $keuangan = DB::table('keuangan')->where('id', $id)->get();
        return view('Pendeta.formubahkeuangan', ['keuangan'=>$keuangan]);
    }
    ...
    public function updatekeuangan(Request $request, $id){
        ...
        return redirect()->route('pendeta.datakeuangan')->with('success', 'Data Keuangan berhasil diperbarui');
    }
    ...
    public function ubahstatuskeuangan2($id){
        ...
        return redirect()->route('pendeta.datakeuangannonaktif')->with('success', 'Data Keuangan berhasil diperbarui');
    }
    
    public function laporan(){
        $laporankeuangan = LaporanKeuangan::all()->where('status_laporan','Aktif');
        return view("Pendeta.laporankeuangan",compact('laporankeuangan'));
    }

    public function laporan2(){
        $laporankeuangan = LaporanKeuangan::all()->where('status_laporan','Non-Aktif');
        return view("Pendeta.laporankeuangannonaktif",compact('laporankeuangan'));
    }

    public function laporankeuangan(Request $request){
        return view("Pendeta.formtambahlaporankeuangan");
    }
    ...
    public function laporankeuanganprocess(Request $request){
        ...
        return redirect()->route("pendeta.laporankeuangan");
    }

    public function ubahlaporankeuangan($id){
        $laporankeuangan = DB::table('laporan_keuangan')->where('id', $id)->get();
        return view('Pendeta.formubahlaporankeuangan', ['laporankeuangan'=>$laporankeuangan]);
    }
    ...
    public function ubahlaporankeuanganprocess(Request $request, $id){
        ...
        return redirect()->route('pendeta.laporankeuangan')->with('success', 'Data Keuangan berhasil diperbarui');
    }
    ...
    public function ubahstatuslaporan2($id){
        ...
        return redirect()->route('pendeta.laporankeuangannonaktif')->with('success', 'Data Keuangan berhasil diperbarui');
    }
    ...
    public function statistik(){
        ...
        return view('Pendeta.statistikkeuangan',['bulan'=>$bulan,'totalpemasukan'=>$totalpemasukan,'totalpengeluaran'=>$totalpengeluaran]);
       
    }
    
    public function caridanapemasukan(){
        return view('Pendeta.formcaridanapemasukan');
    }
    ...
    public function pemasukan(){
        if(request('tAwal') && request('tAkhir')){
            ...
            ->whereBetween('tanggal',[$tAwal,$tAkhir])->get();
            return view('Pendeta.danapemasukan',['danapemasukan'=>$danapemasukan,'totalpemasukan'=> $totalpemasukan]);
    ...
    public function caridanapengeluaran(){
        return view('Pendeta.formcaridanapengeluaran');
    }
    ...
    public function pengeluaran(){
        if(request('tAwal') && request('tAkhir')){
            ...
            ->whereBetween('tanggal',[$tAwal,$tAkhir])->get();
            return view('Pendeta.danapengeluaran',['danapengeluaran'=>$danapengeluaran,'totalpengeluaran'=> $totalpengeluaran]);
    ...
    public function pemasukan1(){
        ...
        return view('jemaat.danapemasukan',compact('danapemasukan'));
    }
    
    public function pengeluaran1(){
        $danapengeluaran = Keuangan::where(["jenis_keuangan"=>"Pengeluaran", "status_keuangan"=>"Aktif"])->get();
        return view('jemaat.danapengeluaran',compact('danapengeluaran'));
    }

    public function carilaporanmingguan(){  
        return view('Pendeta.formcarilaporanmingguan');
    ...
    public function processcarilaporanmingguan(){
        if(request('month')){     
            ...
            return view('Pendeta.laporankeuanganmingguan',compact('laporankeuangan'));
    ...
    public function pdfmmingguan($tanggal_awal,$tanggal_akhir, $id){
        ...
        return view('Pendeta.cetakmasukmingguan', [
    ...
    public function carilaporanbulanan(){  
        return view('Pendeta.formcarilaporanbulanan');
    ...
    public function processcarilaporanbulanan(){
        if(request('tahun')){
            ...
            return view('Pendeta.laporankeuanganbulanan',compact('laporankeuangan'));
        }else{
            return view('Pendeta.formcarilaporanbulanan');
        }
    }
    ...
    public function carilaporantahunan(){  
        return view('Pendeta.formcarilaporantahunan');
    ...
    public function processcarilaporantahunan(){
        if(request('tahun')){
            ...
            return view('Pendeta.laporankeuangantahunan',compact('laporankeuangan'));
        }else{
            return view('Pendeta.formcarilaporantahunan');
        }
    }
    ...
    public function laporanmingguan($tanggal_awal,$tanggal_akhir, $id){
        ...
        return view('Pendeta.laporanmingguan', [
            'laporanpemasukan'=>$laporanpemasukan,'laporanpengeluaran'=>$laporanpengeluaran,
            'totalpengeluaran'=>$totalpengeluaran,
            'totalpemasukan' => $totalpemasukan, 'namalaporan'=>$namalaporan
        ]);
    ...
    public function laporanbulanan($tanggal_awal,$tanggal_akhir, $id){
        ...
        return view('Pendeta.laporanbulanan', [
     ...
     public function pdfmbulanan($tanggal_awal,$tanggal_akhir, $id){
        ...
        return view('Pendeta.cetakmasukbulanan', [
            'laporanbulanan1' => $laporanbulanan1,'laporanbulanan2'=> $laporanbulanan2,
            'laporanbulanan3' => $laporanbulanan3,'laporanbulanan4'=> $laporanbulanan4,
            'laporanbulanan5' => $laporanbulanan5,'laporanbulanan6'=> $laporanbulanan6,
            'laporanbulanan7' => $laporanbulanan7,'laporanbulanan8'=> $laporanbulanan8,
    ...
    public function laporantahunan($tanggal_awal,$tanggal_akhir, $id){
        ...
        return view('Pendeta.laporantahunan', [
    ...
    public function pdfmtahunan($tanggal_awal,$tanggal_akhir, $id){
        ...
        return view('Pendeta.cetakmasuktahunan', [
            'laporantahunan1' => $laporantahunan1,'laporantahunan2'=> $laporantahunan2,
            'laporantahunan3' => $laporantahunan3,'laporantahunan4'=> $laporantahunan4,
            'laporantahunan5' => $laporantahunan5,'laporantahunan6'=> $laporantahunan6,
            'laporantahunan7' => $laporantahunan7,'laporantahunan8'=> $laporantahunan8,
