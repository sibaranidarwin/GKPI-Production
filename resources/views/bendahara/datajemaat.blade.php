                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex gap-3 flex-column flex-md-row">
                                        <a href="/bendahara/data/jemaat/{{ $jemaat->nik }}" data-toggle="tooltip" data-placement="bottom" title="Lihat Data Jemaat" href="#"
                                            class="btn btn-secondary"><i class="fa fa-eye"></i></a>
                                            <a href="/bendahara/data/jemaat/edit/{{ $jemaat->nik }}" data-toggle="tooltip" data-placement="bottom" title="Edit Data Jemaat" 
