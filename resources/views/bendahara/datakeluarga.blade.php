...
<div class="col-12 mt-5 p-3">
    ...
    <div class="col-2 flex">
            <a href="/bendahara/data/keluarga/add"  class="btn btn-success p-2 ms-auto">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex gap-3 flex-column flex-md-row">
                                        <a href="/bendahara/data/keluarga/{{ $keluarga['no_kk'] }}" data-toggle="tooltip" data-placement="bottom" title="Lihat Data Keluarga" href="#"
                                            class="btn btn-secondary"><i class="fa fa-eye"></i></a>
                                            <a href="/bendahara/editdatakeluarga/{{ $keluarga['no_kk'] }}" data-toggle="tooltip" data-placement="bottom" title="Edit Data Keluarga" 
