    ...
    <form action="" method="post" enctype="multipart/form-data">
        ...
        <div class="row">
            ...
            <div class="form-group col-12 col-md-6 mt-3">
                ...
                type = "number" maxlength = "16" class="form-control @error('nik') is-invalid @enderror" name="nik" placeholder="Masukkan Nomor NIK" value="{{ old('nik') }}" >
            ...
            <div class="form-group mt-3 col-6">
                ...
                <input maxlength = "10" type="text" class="form-control @error('username') is-invalid @enderror" name="username" placeholder="Masukkan Username" value="{{ old('username') }}">
