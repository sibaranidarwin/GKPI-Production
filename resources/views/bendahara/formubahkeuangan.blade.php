...
<div class="col-12 p-3 bg-white shadow rounded">
    ...
    <form class="mt-3" action="/pendeta/data/keuangan/update/{{ $datakeuangan->id }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="row">
            <div class="form-group col-12 col-md-6 mt-3">
                ...
                <select name="kategori" id="kategori" class="form-control">
                    ...
                    <option value="Sewa Gedung Aula">Sewa Gedung Aula</option>
                </select>
