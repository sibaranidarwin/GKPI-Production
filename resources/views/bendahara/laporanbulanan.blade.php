    ...
    <div class="row">
        ...
        <div class="col-7 mt-0">   
                     ...
                     <th></th>
                        ...
                        @endforeach 
                            ...
                            <tr>                              
                                ...
                                <td>Penggalangan Dana</td>
                                @foreach ($totalkategori12 as $kategori11)
                ...
                <tr style="border-bottom: solid 1px;">
                    ...
                    <a href="/bendahara/data/keuangan/laporan/download-laporan-bulananm/{{$laporan->tanggal_awal}}/{{$laporan->tanggal_akhir}}/{{$laporan->id}}')"  class="btn btn-success p-2 ms-auto">
