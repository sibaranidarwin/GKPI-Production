                            ...
                            <tr>
                                ...
                                <td style="max-width:100px;">
                                    <div class="d-flex gap-3 flex-column flex-md-row">
                                        <a data-toggle="tooltip" data-placement="bottom" title="Edit Keuangan" href="/bendahara/data/laporan-keuangan/edit/{{$laporan->id}}"
                                            class="btn btn-warning"><i class="fa fa-edit"></i></a>
                                        <a data-toggle="tooltip" data-placement="bottom" title="Aktifkan Laporan Keuangan" href="/bendahara/data/laporan-keuangan/edit/status/nonaktif/{{ $laporan->id }}"
