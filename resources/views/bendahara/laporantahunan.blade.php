    ...
    <div class="row">
        ...
        <div class="col-8 mt-0">   
                    ...
                    <tbody style="border-left: solid 1px;border-right: solid 1px">
                     ...
                     <th></th>
                        ...
                        @endforeach 
                            ...
                            <tr>                              
                                @foreach ($laporantahunan20 as $laporan20)
                ...
                <tr style="border-bottom: solid 1px;">
                    ...
                    <a href="/bendahara/data/keuangan/laporan/download-laporan-tahunanm/{{$laporan->tanggal_awal}}/{{$laporan->tanggal_akhir}}/{{$laporan->id}}')"  class="btn btn-success p-2 ms-auto">
