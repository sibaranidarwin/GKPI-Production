...
@section('title', 'Lihat Ucapan Syukur')
@section('page_name', 'Lihat Ucapan Syukur')
        ...
        <div class="col-12 mt-3">
            <div class="table-responsive">
                ...
                <thead>
                    ...
                    <th class="col-3">Dana Untuk Jemaat</th>
                    <th class="col-3">Dana Untuk Pembangunan</th>
                    <th class="col-3">Dana Untuk Lintas</th>
                    ...
                    <tbody>
                        @foreach ($lihatucapansyukur as $ucapansyukur)
                            <tr>
                                ...
                                <td align="right">   <?php
                             echo "Rp." . number_format($ucapansyukur ['nominal'], 2, ",", ".");
                            ?>
                         </td>
                                <td align="right">   <?php
                             echo "Rp." . number_format($ucapansyukur ['dana_untuk_jemaat'], 2, ",", ".");
                            ?>
                         </td>
                                <td align="right">   <?php
                             echo "Rp." . number_format($ucapansyukur ['dana_untuk_pembangunan'], 2, ",", ".");
                            ?>
                         </td>
                                <td align="right">   <?php
                             echo "Rp." . number_format($ucapansyukur ['dana_untuk_lintas'], 2, ",", ".");
                            ?>
                         </td>
                                <td>
...
<script>
        $(document).ready(function() {
            $('#list').DataTable({
                ...
                "language": {
                    "lengthMenu": "Tampilkan _MENU_ Daftar Ucapan Syukur per halaman",
                    "zeroRecords": "Maaf, tidak dapat menemukan apapun",
                    "info": "Menampilkan halaman _PAGE_ dari _PAGES_ halaman",
                    "infoEmpty": "Tidak ada daftar Ucapan Syukur yang dapat ditampilkan",
