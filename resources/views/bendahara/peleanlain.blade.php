...
@section('title', 'Pelean Lain')
@section('page_name', 'Pelean Lain')
        ...
        <div class="col-12 mt-3">
            ...
            <table class="table table-bordered mb-0" id="list">
                    ...
                    @endphp
                        ...
                        <form action=""></form>
                            <tr>
                            <td>{{ $pelean_lain -> tanggal_lain}}</td>
                                <td>{{ $pelean_lain -> keterangan_lain}}</td>
                                <td>{{ $pelean_lain -> jumlah}}</td>
                                <td align="right">   <?php
                             echo "Rp." . number_format($pelean_lain ['dana_jemaata'], 2, ",", ".");
                            ?>
                         </td>
                                <td align="right">   <?php
                             echo "Rp." . number_format($pelean_lain ['dana_pembangunanb'], 2, ",", ".");
                            ?>
                         </td>
                                <td align="right">   <?php
                             echo "Rp." . number_format($pelean_lain ['dana_lintasc'], 2, ",", ".");
                            ?>
                         </td>
                                <td>
                                    <div class="d-flex gap-3 flex-column flex-md-row">
                                        <a data-toggle="tooltip" data-placement="bottom" title="Edit " href="/bendahara/data/peleanlain/edit/{{ $pelean_lain->id }}"
...
<script>
        $(document).ready(function() {
            $('#list').DataTable({
                ...
                "language": {
                    "lengthMenu": "Tampilkan _MENU_ Data Pelean Lainnya per halaman",
