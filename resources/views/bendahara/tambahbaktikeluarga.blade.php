...
@section('title', 'Bakti Keluarga')
@section('page_name', 'Bakti Keluarga')
                ...
                <div class="header-body text-left mt-2 mb-4">
                    <div class="row justify-content">
                        <div class="row col-lg-12 col-md-4 border-bottom">
                            <div class="col-10">
                            <h2 class="text">Tambah Bakti Bulanan dan Pembagunan Keluarga</h2>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <form class="" action="" method="post" enctype="multipart/form-data">
        ...
        <div class="row">
            <div class="form-group mt-3 col-6">
                ...
                <select name="no_kk" id="no_kk" class="form-select">
                    <option disabled selected>Pilih No Kartu Keluarga</option>
                    @foreach ($no_kks as $no_kk)
                        <option value="{{ $no_kk['no_kk'] }}">{{ $no_kk['no_kk'] }}</option>
                    @endforeach
                </select>
            </div>
            <div class="form-group col-12 col-md-6 mt-3">
                <label for="nama_keluarga">Nama Keluarga</label>
                <input type="text" name="nama_keluarga" id="nama_keluarga" placeholder="Masukkan Nama Keluarga" class="form-control">
