...
@section('title', 'Ucapan Syukur')
@section('page_name', "Ucapan Syukur")
@section('content')
...
<div class="col-12 p-3 bg-white shadow rounded">
    ...
    <form class="mt-3" action="" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group col-12 col-md-6 mt-3">
                <label for="tanggal">Tanggal Penyetoran Ucapan Syukur</label>
        ...
        <div class="form-group col-12 col-md-6 mt-3">
            ...
            <input type="number" name="nominal" placeholder="Masukkan Nominal Setoran" id="nominal" class="form-control">
        </div>
        <div class="form-group col-12 col-md-6 mt-3">
        ...
        <div class="form-group col-12 col-md-6 mt-3">
                ...
                <textarea name="keterangan" placeholder="Masukkan Keterangan Ucapan Syukur" class="form-control @error('keterangan') is-invalid @enderror" id="keterangan" cols="20" rows="5" class="form-control"></textarea>
