...
<div class="row">
        ...
        <div class="row">
            ...
            <label class="form-control-label" for="isi">Isi Renungan</label>
                            <input type="text" class="form-control @error('isi') is-invalid @enderror" name="isi" placeholder="Masukkan Isi Renungan" value="{{ old('isi') }}">
            ...
            <div class="col-12 col-md-6 mt-4">
                ...
                <a href="{{ route('tatausaha.renunganshow') }}" class="btn btn-primary">
