                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex gap-3 flex-column flex-md-row">
                                        <a href="/pendeta/data/keluarga/{{ $keluarga['no_kk'] }}" data-toggle="tooltip" data-placement="bottom" title="Lihat Data Keluarga" href="#"
                                            class="btn btn-secondary"><i class="fa fa-eye"></i></a>
                                        <a href="/pendeta/editdatakeluarga/{{ $keluarga['no_kk'] }}" data-toggle="tooltip" data-placement="bottom" title="Edit Data Keluarga" 
