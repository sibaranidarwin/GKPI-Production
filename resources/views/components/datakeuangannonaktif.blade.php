                            ...
                            <tr>
                                ...
                                <td style="">
                                    <div class="d-flex gap-3 flex-column flex-md-row">
                                        <a data-toggle="tooltip" data-placement="bottom" title="Edit Keuangan" href="/pendeta/data/keuangan/edit/{{ $keuangan->id }}"
                                            class="btn btn-warning"><i class="fa fa-edit"></i></a>
                                        <a data-toggle="tooltip" data-placement="bottom" title="Aktifkan Keuangan" href="/pendeta/data/keuangan/edit/status/nonaktif/{{ $keuangan->id}}"
