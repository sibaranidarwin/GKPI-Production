            ...
            <div class="table-responsive col-md-11 col-12">
                <table class="mt-4 table">
                    <form action="/pendeta/data/jemaat/edit" method="POST">
                            ...
                            <td>
                                <select name="status" class="form-select" id="inputJemaat4" required disabled>
                                    ...
                                    <option value="Meninggal" {{ $jemaat->status == "Meninggal" ? 'selected' : '' }}>Meninggal</option>
                                     <option value="Lahir" {{ $jemaat->status == "Lahir" ? 'selected' : '' }}>Lahir</option>
                        ...
                        <tr>
                            <td>Tanggal Lahir</td>
                            <td><input type="date" name="tanggal_lahir" class="form-control" id="inputJemaat10" value="{{ $jemaat['tanggal_lahir'] }}" required disabled></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td><button type="button" class="btn btn-warning" onclick="editjemaat()">Ubah Data Jemaat</button></td>
