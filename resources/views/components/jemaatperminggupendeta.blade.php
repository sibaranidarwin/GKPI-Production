                ...
                <div class="header-body text-left mt-3 mb-4">
                    <div class="row justify-content">
                        <div class="row col-lg-12 col-md-4 border-bottom">
                            <div class="col-10">
                            <h2 class="text"> Data Jumlah Jemaat yang Beribadah dalam Seminggu</h2>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <tbody>
                        ...
                        <tr>
                                ...
                                <td>
                                    ...
                                    <a href="/pendeta/editdatajemaatperminggu/{{ $statistik_jemaat['id'] }}" data-toggle="tooltip" data-placement="bottom" title="Edit Data Jemaat Perminggu" 
