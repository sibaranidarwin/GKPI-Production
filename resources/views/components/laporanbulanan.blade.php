    ...
    <div class="row">
        ...
        <div class="col-7 mt-0">   
                ...
                <tr style="border-bottom: solid 1px;">
                    ...
                    <a href="/pendeta/data/keuangan/laporan/download-laporan-bulananm/{{$laporan->tanggal_awal}}/{{$laporan->tanggal_akhir}}/{{$laporan->id}}')"  class="btn btn-success p-2 ms-auto">
