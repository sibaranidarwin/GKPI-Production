    ...
    <div class="row">
        ...
        <div class="col-8 mt-0">   
                ...
                <div class="col-2 d-flex">
                    <a href="/pendeta/data/keuangan/laporan/download-laporan-mingguanm/{{$laporan->tanggal_awal}}/{{$laporan->tanggal_akhir}}/{{$laporan->id}}')"  class="btn btn-success p-2 ms-auto">
