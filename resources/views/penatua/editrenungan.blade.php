        ...
        <div class="card  shadow h-100">
            ...
            <form autocomplete="off" action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                            ...
                            <input type="date" class="form-control @error('tanggal') is-invalid @enderror" name="tanggal" value="{{ $renunganas->tanggal }}">
                    ...
                    <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('ayat') is-invalid @enderror" name="ayat" value="{{ $renunganas->ayat }}">
                    ...
                    <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('title') is-invalid @enderror" name="title" value="{{ $renunganas->title }}">
