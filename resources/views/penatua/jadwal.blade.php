    ...
    <div class="col-12 shadow-sm rounded bg-white p-3">
        <div class="col-12">
            ...
            <table class="table table-bordered" id="list">
                    <thead>
                        <tr>
                            <th scope="col">Nama Jadwal Ibadah</th>
                    ...
                    <tbody>
                        @foreach ($jadwal_ibadah as $item)
                            <tr>
                                ...
                                <td>
                                <a href="/penatua/editjadwal/{{ $item['id'] }}" class="btn btn-warning hapus-data" title="Edit" style="color: white;"><i class="fa fa-edit"></i></a>
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
