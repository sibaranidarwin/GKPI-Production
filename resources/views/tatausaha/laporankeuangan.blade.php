...
display: block;
    ...
    <div class="col-12 shadow-sm rounded mt-3 bg-white p-3">
        ...
        <div class="col-2 d-flex">
            <a href="/tatausaha/data/laporan-keuangan/add"  class="btn btn-success p-2 ms-auto">
                            ...
                            <tr>
                                ...
                                <td style="">
                                    <div class="d-flex gap-3 flex-column flex-md-row">
                                        <a data-toggle="tooltip" data-placement="bottom" title="Edit Keuangan" href="/tatausaha/data/laporan-keuangan/edit/{{$laporan->id}}"
                                            class="btn btn-warning"><i class="fa fa-edit"></i></a>
                                        <a data-toggle="tooltip" data-placement="bottom" title="Non-Aktifkan Laporan Keuangan" href="/tatausaha/data/laporan-keuangan/edit/status/{{ $laporan->id }}"
