...
@section('title', 'Laporan Keuangan Mingguan')
...
<div class="col-12 shadow-sm rounded mt-3 bg-white p-3">
        ...
        @foreach ($laporankeuangan as $laporan)
            ...
            <div class="card text-white bg-primary mb-4">
               <a href="/tatausaha/data/laporan-keuangan-mingguan/{{ $laporan->tanggal_awal }}/{{ $laporan->tanggal_akhir }}/{{ $laporan->id}}"  class="btn btn-primary"> 
                   <div class="card-body">
