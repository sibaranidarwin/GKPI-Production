...
@section('title', 'Kelola Laporan Keuangan Non-Aktif')
                            ...
                            <tr>
                                ...
                                <td style="max-width:100px;">
                                    <div class="d-flex gap-3 flex-column flex-md-row">
                                        ...
                                        <a data-toggle="tooltip" data-placement="bottom" title="Aktifkan Laporan Keuangan" href="/tatausaha/data/laporan-keuangan/edit/status/nonaktif/{{ $laporan->id }}"
